...
\Large
Implementacja i analiza wydajności programu do symulacji Particle-in-Cell w języku Python\\ % <<<<<<<<<< title of thesis in polish
...
\vspace{-1.5cm}
\begin{flushleft}
	Tytuł pracy: Implementacja i analiza wydajności programu do symulacji Particle-in-Cell w języku Python% <<<<<<<<<< title of thesis in polish
\end{flushleft}
\vspace{0.5cm}
...
\vspace{-1.5cm}
\begin{flushleft}
	Title of the thesis: Implementation and performance analysis of a Particle-in-Cell simulation code in Python% <<<<<<<<<< title of your thesis in english
\end{flushleft}
\vspace{0.5cm}
\input{Text/abstract_en.tex} % <<<<<<<<<< here write your abstract
\\
\vspace{0.5cm}
\noindent \textit{Keywords: \\ python, plasma, particle in cell, simulation, optimization, electrodynamics} % <<<<<<<<<< key words
\vfill
(podpis opiekuna naukowego) \hfill (podpis dyplomanta)
...
\center \textit{\textbf{Implementacja i analiza wydajności programu do symulacji Particle-in-Cell w języku Python}} % <<<<<<<<<< title of your thesis
