...
\todo[inline]{sprawdzić dokładnie ile, rzędu 4\%}\% czasu trwania symulacji). % TODO BENCHMARK
...
%TODO jak sformalizować warunek zachowania ładunku? check Villasenor
%TODO-IDEA depozycja ładunku w mojej obecnej wersji nie jestem wcale przekonany że zachowuje ładunek
...
tak zwanej poprawki Borysa\cite{ren-presentation}, %TODO PC
...
\todo[inline]{rysunek: przykład z ipynb} % TODO PC
