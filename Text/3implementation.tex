...
\todo[inline]{sprawdzić}
    ...
    \todo[inline]{rysunek: rozklady gestosci}
    \todo[inline]{czy wykladnik taki jak jest teraz w wykladniczej preplazmie jest ok?

    W biezacej wersji kodu predkosci czastek inicjalizowane sa jako zera. Jest to
    \todo[inline]{do zmiany}
    uzasadnione niewielkim znaczeniem poczatkowej predkosci czastek w
    porownaniu do efektow, jaki ma na nich impuls laserowy.
    ...
    Uruchamianie kodu w celu zmierzenia wydajnosci polegalo na uruchomieniu skryptu \code{make benchmark},ktory:
    1. Czysci zawartosc folderu data_analysis
