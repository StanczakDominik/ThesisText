\section[Implementacja]{Implementacja}% 20-30% - opis przyjętych rozwiązań i uzasadnienie ich wyboru
    ...
    przynależy, poprzez $x' = (x/dx) - i_x)$ \todo[inline]{zweryfikować} .
    ...
    \subsubsection{Dlaczego depozycja prądu jest złożonym zagadnieniem?}
    ...
    \todo[inline]{depozycja poprzeczna}
    \subsection{Depozycja podłużna}
    \todo[inline]{depozycja podłużna}
    ...
    \todo[inline]{przenieść to do depozycji cząstek bo to ten sam algo, liniowa
    interpolacja}
