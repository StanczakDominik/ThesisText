...
\begin{figure}[h!]
  ...
  \label{fig:charge-deposition}
  \caption{Ilustracja depozycji ładunku poprzez skalowanie pola \english{(area weighting)}.}
...
\begin{figure}[h!]
  ...
  \label{fig:deposition-movement}
  \caption{Ilustracja ruchu cząstki poruszającej się z maksymalną prędkością dozwoloną w symulacji.}
\end{figure}
...
\begin{enumerate}
    ...
    %TODO Do której komórki trafia ładunek w każdej iteracji?
