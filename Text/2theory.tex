\section[Część analityczno-teoretyczna]{Część analityczno-teoretyczna} % 30% pracy - opis problematyki podjętego tematu w zakresie wykorzystanym w pracy i analizie
    ...
    jądrowej, jest silnie skorelowany z % TODO: odniesienie - wykład z youtube, muszę go znaleźć
    ...
    te znoszą się, co rozumie się w plazmie jako \emph{kwaziobojętność} - jednak
    ...
    Idea modelu particle-in-cell (dalej nazywanego \emph{PIC}) jest wyjątkowo
    ...
    sprzężonych) % TODO: ref
     lub spektralnie, przy użyciu transformat
    Fouriera bądź Hankela. % TODO ref
    ...
    \todo[inline]{To jest generalnie moja własna interpretacja tej wielkości, ale wszystkie wzory
    zdają się zgadzać.}
    ...
    numerycznych% TODO dopisać zalety
    ...
    PyFR, łączącym szybkie obliczenia w CUDA C i Fortranie % TODO sprawdzić czy fortran

    z wysokopoziomowością Pythona. Uruchomiono go na klastrze % TODO klaster

    i udowodniono jego skalowanie do poziomów % TODO obejrzeć tamtą prezentację
    % TODO refka i opis PyFR
    ...
    zrównoleglane % TODO refka intel MKL
    ...
    gęstości plazmy.  % TODO czy stosuję scipy gdzieś jeszcze
    ...
    bądź Fortranie. % TODO refka
     Jednocześnie należy zaznaczyć prostotę jej
    użycia:

    % TODO fragment kodu. @jit przed kodem
    ...
    biblioteka h5py. % TODO reference h5py
     Używa się go na przykład w
    % TODO lista miejsc gdzie używają hdf5
    ...
    % TODO przykład testu z programu
    ...
    uruchamianiu lżejszych, acz wciąż zasobożernych % TODO to słowo
