\section[Część analityczno-teoretyczna]{Część analityczno-teoretyczna} % 30% pracy - opis problematyki podjętego tematu w zakresie wykorzystanym w pracy i analizie
    ...
    Globalny wzrost zainteresowania fizyką plazmy na arenie geopolitycznej rozpoczął się w latach '50 ubiegłego wieku,
    ...
    między Stanami Zjednoczonymi a ZSRR,
    ...
    Ostatnimi czasy popularną staje się również kompilacja
    Just-in-time wysokopoziomowego kodu Pythona do kodu niskopoziomowego przy
    pierwszym uruchomieniu programu \todo[inline]{numba}.

    Istniejącym od niedawna kodem implementującym tą metodę jest FBPIC \todo[inline]{refka}
