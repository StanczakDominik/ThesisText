\section[Część analityczno-teoretyczna]{Część analityczno-teoretyczna} % 30% pracy - opis problematyki podjętego tematu w zakresie wykorzystanym w pracy i analizie
    ...
    i udowodniono jego skalowanie do poziomów \todo[inline]{sprawdzić czy
    fortran, jaki to klaster, obejrzeć tamtą prezentację, refka i opis PyFR}
    ...
    bądź Fortranie. \todo[inline]{refka}
    ...
    biblioteka h5py. \todo[inline]{reference h5py}
