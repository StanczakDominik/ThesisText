...
dx$ \todo[inline]{dx} obserwuje się nieliniowy reżim oscylacji, % TODO
...
znaczących różnic w symulacji, w której pole elektryczne skierowano w kierunku osi $\hat{z}$) %TODO CHECK
oraz
...
tablic, jak obrazuje następująca tabela: % TODO TABLE
