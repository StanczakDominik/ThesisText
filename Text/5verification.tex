...
\todo[inline]{tu jeszcze kombinuję z najsensowniejszym wrzuceniem snapshotów dobrze oddających dynamikę układu, najchętniej bym wkleił animację ale w pracy do druku się jeszcze nie da}
...
oraz ułamek tego czasu spędzony w funkcji
\code{iteration}.
\subsubsection{line\_profiler}
\todo[inline]{W trakcie pisania}
