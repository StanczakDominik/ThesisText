...
\todo{sprawdzić}
    ...
    Należy zauważyć, że operacje matematyczne w Numpy są automatycznie zrównoleglane \todo{refka intel MKL}
    ...
    \begin{itemize}
        ...
        \item plotting - zawiera ustawienia dotyczące analizy danych \todo{TODO czy to można przenieść do simulation czy gdzieś?}
    \end{itemize}

    Przygotowane konfiguracje istniejących symulacji są zawarte w plikach \code{configs/run\_*}: \todo{TODO przeformułować}
    \begin{itemize}
...
\section[Weryfikacja]{Część weryfikacyjna} % 30-40% - opis wyników, analiza, weryfikacja i porównanie do danych literaturowych
    ...
    W repozytorium Git na Githubie jest to commit ``placeholder'' \todo{TODO: uzupełnić commita}
    ...
    pakietu \code{pytest} \todo{TODO: pytest reference.} i większości były
    ...
    dla innych przypadków, takich jak efekt Kaiser-Wilhelm \todo{TODO: sformułowanie z BL}
