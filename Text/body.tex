...
\item badania interakcji laserów z plazmą w kontekście tworzenia niewielkich,
    ...
    \subsubsection{Leapfrog oraz Borys} \todo{ REWRITE}
...
\todo{sprawdzić}
    ...
    \todo{ TODO REFERENCE źródło na powolność pętli}
    ...
    \subsubsection{Numba}
    \code{numba} to biblioteka służąca do kompilacji just-in-time kodu. \todo{ TODO ogarnąć jak właściwie działa numba}
    W wielu przypadkach \todo{ TODO odniesienie}
    pozwala na osiągnięcie kodem napisanym w czystym Pythonie wydajności marginalnie
    niższej bądź nawet równej do analogicznego programu w C. \todo{ TODO czy były takie testy z fortranem}
    Jednocześnie należy zaznaczyć prostotę jej użycia: \todo{TODO}

    \todo{ TODO fragment kodu}
    ...
    \code{py.test} jest oprogramowaniem otwartym, dostępnym na licencji \todo{ TODO}
