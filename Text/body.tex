...
\section{Implementacja}% 20-30% - opis przyjętych rozwiązań i uzasadnienie ich wyboru
...
Kod przetestowano w dwojaki sposób. Poszczególne algorytmy podlegały testom jednostkowym
przy użyciu modułu pytest % TODO: pytest reference
\begin{enumerate}
    \item Gather
    \begin{enumerate}
        % TODO: itemii?
...
Utworzono kod symulacyjny stosujący algorytm particle-in-cell w Pythonie, który zoptymalizowano.
