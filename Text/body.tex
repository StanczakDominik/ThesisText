...
% TODO alternatywa na słowo "oczko"?
    ...
    * algorytm ewolucji pola staje się trywialny, zwłaszcza w 1D - ogranicza się do elementarnego dodawania i mnożenia % TODOpoprawić
...
% TODO: rysunek: przykład z ipynb
    ...
    \subsubsection{Numpy}
    \code{numpy} to biblioteka umożliwiająca wykonywanie złożonych obliczeń na wielowymiarowych macierzach
    oraz tablicach.
    Pod zewnętrzną powłoką zawiera odwołania do
    znanych, wypróbowanych i sprawdzonych w numeryce modułów LAPACK, BLAS
    % TODO itd - dopisać przykłady pozostałych bibliotek algebraicznych oraz zweryfikować na czym
    % w ogóle stoi numpy
    ...
    Numpy jest oprogramowaniem otwartym na licencji BSD. % TODO refka
    ...
    Przy pracy nad kodem użyto frameworku testowego py.test % TODO link w stopce
