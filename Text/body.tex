...
% TODO: runaway electrons - przeformułować
    ...
    leapfrog % TODO reference
    stosowany tam, gdzie potrzebna jest długofalowa stałość energii symulacji. Wynika to z symplektyczności % TODO READ
    ...
    W przypadku ruchu w polu magnetycznym nie wystarczy, niestety, użyć zwykłego algorytmu leapfrog. % TODO READ
    Używa się tutaj specjalnej adaptacji tego algorytmu na potrzeby ruchu w zmiennym polu elektromagnetycznym,
    tzw pushera % TODO REWRITE
    Borysa % TODO REFERENCE
    który rozbija pole elektryczne na dwa impulsy, między którymi następują dwie % TODO REWRITE
    rotacje polem magnetycznym. Algorytm jest w ten sposób symplektyczny % TODO REWRITE
